...
export const Navbar = () => {
  ...
  const navItems = isAthlete ? [
    ...
    { label: "Chat", icon: MessageSquare, path: `/chat/${user.coachId || 'coach'}` },
  ] : [
  ...
  return (
    <>
      {/* Top Header */}
      <header className="sticky top-0 z-40 w-full border-b border-zinc-800/80 bg-[#0c0e12]/80 backdrop-blur-xl" data-testid="navbar">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-6">
              ...
              >
                <div className="h-9 w-9 rounded-xl bg-gradient-to-tr from-emerald-600 to-indigo-600 flex items-center justify-center shadow-lg shadow-emerald-500/10 group-hover:scale-105 transition-transform">
                  <Dumbbell className="h-5 w-5 text-white" />
                </div>
                <div className="flex flex-col">
                  <span className="font-heading font-extrabold text-lg tracking-tight text-white flex items-center gap-1.5">
                    CoachSheets <span className="text-[10px] uppercase font-bold tracking-wider px-1.5 py-0.5 rounded bg-emerald-500/10 text-emerald-400 border border-emerald-500/20">OpenGym</span>
                  </span>
                </div>
              </button>
            ...
            <div className="flex items-center gap-3">
              {isAthlete && (
                <div className="flex items-center gap-1.5 bg-zinc-900/90 border border-zinc-800 p-1 rounded-xl">
                  ...
                  <Dialog>
                    <DialogTrigger asChild>
                      <Button variant="ghost" size="icon" className="h-8 w-8 text-indigo-400 hover:bg-indigo-500/10 rounded-lg" title="Timer & Strumenti">
              ...
              <Button 
                ...
                size="icon" 
                onClick={toggleTheme} 
                className="h-9 w-9 text-zinc-400 hover:text-white hover:bg-zinc-800/60 rounded-xl" 
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-56 bg-zinc-900 border-zinc-800 text-zinc-200">
                  ...
                  <DropdownMenuItem onClick={logout} className="gap-2 cursor-pointer focus:bg-red-500/10 text-red-400" data-testid="logout-btn">
      ...
      {/* OpenGym Style Bottom Navigation Bar for Mobile */}
